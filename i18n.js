...
export const T = {
  pl: {
    ...
    openReader: 'skan i transkrypcja', openTranscript: 'otwórz transkrypcję',
    transcription: 'Transkrypcja', noTranscript: 'Jeszcze jej nie ma.',
    leaf: 'karta',
    noScan: 'Do tego listu nie ma jeszcze skanu.',
    noScanSub: 'Czytnik czeka na materiał — wystarczy podać manifest IIIF albo adres obrazu.',
    scanFail: 'Nie udało się wczytać skanu.',
  ...
  en: {
    ...
    openReader: 'scan and transcription', openTranscript: 'open the transcription',
    transcription: 'Transcription', noTranscript: 'Not available yet.',
    leaf: 'leaf',
    noScan: 'No scan for this letter yet.',
    noScanSub: 'The reader is waiting for material — a IIIF manifest or an image URL is enough.',
    scanFail: 'The scan could not be loaded.',
